...
│ .gitignore │ 建议有，非必须 │ 让 target 自动被忽略         
│ README.md  │ 建议有，非必须 │ 说明文档                     
│ CLAUDE.md  │ 否 │ 私人仓库可以，对外不行         
│ target/    │ 否 │ 4.2 GB,且是编译产物。用.gitignore 里记录它让它已经排除了  

一句话:除了 target/,其余全传(所以你在这里看不到target文件夹)。
开发后感悟：rust这门编程语言，编译速度太慢了,临时文件太大了
